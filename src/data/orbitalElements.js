...
for (const planet of Object.values(elements)) {
  for (const pair of Object.values(planet)) Object.freeze(pair);
  Object.freeze(planet);
}

export const ORBITAL_ELEMENTS = Object.freeze(elements);
